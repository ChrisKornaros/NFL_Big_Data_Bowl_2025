-- Testing an expansion of the agg_play table with more play outcomes and types
WITH game AS (
    SELECT
        gameId,
        homeTeamAbbr,
...
play AS (
    SELECT
        ...
        receiverAlignment,
        CASE
            WHEN passing_yards IS NOT NULL THEN 'Pass'
            WHEN rushing_yards IS NOT NULL THEN 'Rush'
            ELSE 'Other'
        END AS play_type,
        yardsGained,
        CASE
